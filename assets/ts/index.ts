...
let rulle1Overflowing = document.querySelector('.rulle1-overflowing') as HTMLDivElement;
let rulle2Overflowing = document.querySelector('.rulle2-overflowing') as HTMLDivElement;
let rulle3Overflowing = document.querySelector('.rulle3-overflowing') as HTMLDivElement;
let gevinstDisplayElement = document.querySelector('.gevinst-ul') as HTMLUListElement;
let startBtnElement = document.querySelector('.start-btn') as HTMLButtonElement;
let autoBtnElement = document.querySelector('.auto-btn') as HTMLButtonElement;
let betalMønterBtnElement = document.querySelector('.betal-mønter') as HTMLButtonElement;
let møntIndkast = document.querySelector('.mønt-indkast') as HTMLInputElement;
let rulle1Displayed = document.querySelector('.rulle1') as HTMLDivElement;
let mønterElement = document.querySelector('.mønter') as HTMLElement;
let winRateDisplayElement = document.querySelector('.win-rate') as HTMLElement;
let spilResultat = document.querySelector('.spil-resultat') as HTMLElement;
let freeSpinsDisplayElement = document.querySelector('.free-spins') as HTMLElement;
let gameCountDisplayElement = document.querySelector('.game-count') as HTMLElement;
...
let mønter: number = 200;
let allowSpin: number = 10;
let currentlySpinning: boolean = false;
let freeSpinCount: number = 0;
let arrayExtentions: number = 5;
let gameCount: number = 0;
let winCount: number = 0;
let autoSpinActive: boolean = false;
let autoSpinInterval: number;
...
let rulle1Index: number;
let rulle2Index: number;
let rulle3Index: number;


let rulle1RamtFigur: string;
let rulle2RamtFigur: string;
let rulle3RamtFigur: string;
...
function makeRulle1() {
	...
	rullerArray[0].forEach((rulle1: any) => {
		let rulleFigur = document.createElement('img') as HTMLImageElement;
...
function makeRulle2() {
	...
	rullerArray[1].forEach((rulle2: any) => {
		let rulleFigur = document.createElement('img') as HTMLImageElement;
		rulleFigur.style.height = `${figurHøjde}px`;
...
function makeRulle3() {
	...
	rullerArray[2].forEach((rulle3: any) => {
		let rulleFigur = document.createElement('img') as HTMLImageElement;
		rulleFigur.style.height = `${figurHøjde}px`;
...
function startSpinning(Number1: number, Number2: number, Number3: number) {
	setTimeout(() => {
...
function winOrLose(figur1: string, figur2: string, figur3: string) {
